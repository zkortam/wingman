...
export const ToolCallReviewRequestSchema = z
  .object({
    ...
    // Empty is valid: an agent-initiated tool call has no new user message, and rejecting it would.
    userMessage: z.string().max(10_000),
  ...
  .strict()
export type ToolCallReviewRequest = z.infer<typeof ToolCallReviewRequestSchema>

export const ToolCallReviewActionSchema = z.enum(['ALLOW', 'RETHINK', 'ESCALATE'])
export type ToolCallReviewAction = z.infer<typeof ToolCallReviewActionSchema>
...
export type ToolCallReviewDecision = z.infer<typeof ToolCallReviewDecisionSchema>
