...
import { ToolCallReviewDecisionSchema, ToolCallReviewRequestSchema } from './review.js'
...
describe('tool-call review contracts', () => {
  it('accepts a redacted request and rejects raw identity', () => {
    ...
    expect(ToolCallReviewRequestSchema.safeParse({ ...request, userId: 'raw-user' }).success).toBe(
      false,
    )
  })
