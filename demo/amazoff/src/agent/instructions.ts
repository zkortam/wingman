 ...
 *
 * The customer will not type a structured field. This keeps the common phrasings
 * deterministic so the demo does not depend on a model for "leave it at the door".
 */
