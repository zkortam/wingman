...
export class ReplayPipelineRepository implements PipelineRepository {
  ...
  declare promoteAssertion: PipelineRepository['promoteAssertion']
  ...
  declare listIncidents: PipelineRepository['listIncidents']
  declare incidentInOrg: PipelineRepository['incidentInOrg']
